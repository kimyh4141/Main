...
;
            ...
            {
                MessageBox.ShowCaption("无法找到 PCB 条码打印历史记录。 \r\nNot Found.", "误差 (Error)", MessageBoxIcon.Error);
            }
        }
        ...
        private void btn_Reprint_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("未选择 PCB。\r\nPCB is not selected.", "警告 (Warning)", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }
