...
namespace WiseM.Client
{
    ...
    {
        public ProductBarcodeReprint(string type)
        {
            InitializeComponent();
        ...
        {
            textBox_Boxbarcode.Text = string.Empty;
                    ...
                    query = $@"
                        SELECT DISTINCT BoxBarcode_2                              AS Barcode
                         ...
                         WHERE ProductionDate BETWEEN '{dateTimePicker_From.Value:yyyy-MM-dd}' AND '{dateTimePicker_To.Value:yyyy-MM-dd}'
                           ...
                           AND ProductionLine = '{textBox_SearchLine.Text}'
        ...
        private void dataGridView_PrintHist_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            textBox_Boxbarcode.Text = $@"{dataGridView_PrintHist.CurrentRow.Cells["Barcode"].Value}";
        ...
        {
            textBox_SearchLine.Text = WbtCustomService.ActiveValues.Workcenter;
        }
