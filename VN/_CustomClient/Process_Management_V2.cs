    ...
    public partial class Process_Management_V2 : SkinForm
    {
        ...
        private void Init()
        {
            try
            {
                ...
                lbl_Reel.Text = $@"Đang kiểm tra Feeder… Feeder Checking .. (Số lượng giới hạn của Feeder : {_thresholdQty})";
                ...
                (
                    new[]
                    {
                        new DataColumn("Cnt"), new DataColumn("PCB #1"), new DataColumn("PCB #2"), new DataColumn("Ngày giờ (DateTime)")
                    }
                );
            ...
            try
            {
                ...
                switch (DbAccess.Default.ExecuteScalar(query.ToString()))
                {
                    case "T":
                        ...
                        lbl_Reel.Text = $@"Feeder còn lại OK。 (Feeder Remaining OK..) (Số lượng giới hạn của Feeder: {_thresholdQty})";
                    ...
                    case "F":
                        ...
                        lbl_Reel.Text = $@"Cảnh báo！Hầu như Feeder！(Warning ! Feeder almost shortage) (Số lượng giới hạn của Feeder : {_thresholdQty})";
