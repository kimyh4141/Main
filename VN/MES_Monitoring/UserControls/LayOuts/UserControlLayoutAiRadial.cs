...
{
    public partial class UserControlLayoutAiRadial
    {
        public Dictionary<int, UserControlLineAi> LineList = new Dictionary<int, UserControlLineAi>();
        public UserControlLayoutAiRadial()
        {
            InitializeComponent();
        }

        public UserControlLayoutAiRadial(IContainer components)
        {
            InitializeComponent();
        ...
        private void UserControlLayoutAiRadial_Load(object sender, System.EventArgs e)
        {
            ...
            {
                pair.Value.UnitList[0].Text = $@"R-{pair.Key:0#}";
            }
        }
