...
{
    public partial class Page_AI : Page_Base
    {
        public Page_AI()
        {
            InitializeComponent();
        ...
        public void SetPage(DataSet dataSet)
        {
            try
            {
                var rows = dataSet.Tables[0].Select("Routing = 'Ai_Unload'");
                ...
                foreach (DataRow row in dataSet.Tables[1].Rows)
                {
                    ...
                    {
                        case "Ai_Load":
                            UserControlLayoutAiAxial.SetLineCondition(Common.Routing.Type.AI_Load, line, (Common.Routing.Condition)intCondition);
                            break;
                        case "Ai_Unload":
                            UserControlLayoutAiRadial.SetLineCondition(Common.Routing.Type.AI_Unload, line, (Common.Routing.Condition)intCondition);
                            break;
                    }
                }
            }
