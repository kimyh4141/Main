    ...
    public partial class PI_frmMain10 : Form
    {
        ...
        private void btnCreateNewResv_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                PI_frmMain20 _form1 = new PI_frmMain20(strUser);
        ...
        private void dgv01_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dtPI.Rows[e.RowIndex]["PI_Status"].ToString() == "Deleted")
            {
            ...
            string PS_RESVNO = dtPI.Rows[e.RowIndex]["ResvNo"].ToString();
            PI_frmMain30 _form1 = new PI_frmMain30(strUser, PS_RESVNO);
            _form1.ShowDialog();
        }
