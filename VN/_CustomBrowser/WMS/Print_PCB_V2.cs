    ...
    public partial class Print_PCB_V2 : Form
    {
        ...
        private void dgv_partNo_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show($"Thiếu một số thông tin cơ bản。\r\n" +
                                                         $"Vui lòng nhập thông tin trong mục thông tin cơ sở。\r\n" +
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = serial; i < serial + print_qty; i++)
                {
                    ...
                    if (!Print(barcode))
                    {
                        MessageBox.ShowCaption("In lỗi (Print Error)", "误差 (Error)", MessageBoxIcon.Error);
                        return;
                    }
                    else
                    {
...
";
        ...
        private void tb_Search_MouseHover(object sender, EventArgs e)
        {
            ...
            this.toolTip1.SetToolTip(this.tb_Search, "Nhập các mục bắt buộc để tìm kiếm。");
        }
        ...
        private void tb_Search1_MouseHover(object sender, EventArgs e)
        {
            ...
            this.toolTip2.SetToolTip(this.tb_Search1, "Vui lòng nhập tên Model để tìm kiếm");
        }
