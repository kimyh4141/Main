...
{
    public partial class BarcodeGeneratorSupplierSearch : Form
    {
        private string _material;
        private string _supplierCode;
        private string _supplierName;

        public BarcodeGeneratorSupplierSearch()
        {
            InitializeComponent();
        }

        public BarcodeGeneratorSupplierSearch(string material, string supplierCode, string supplierName)
        {
            InitializeComponent();
            _material = material;
