...
;
        ...
        private void SetTextBoxHint(Control control, string hint)
        {
            ...
            {
                if (!textBox.Text.Equals(hint)) return;
                textBox.Text = "";
        ...
        private void button_SupplierSearch_Click(object sender, EventArgs e)
        {
            ...
            var newBarcodeSupplierSearch = new BarcodeGeneratorSupplierSearch(textBox_Material.Text, textBox_Supplier.Text, textBox_SupplierName.Text);
        ...
        {
            var newBarcodeTestPrint = new BarcodeGeneratorTestPrint();
