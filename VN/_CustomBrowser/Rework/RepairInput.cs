...
namespace WiseM.Browser
{
    public partial class RepairInput : SkinForm
    {
        ...
        private void SetBadInfo()
        {
            ...
            tb_Barcode.Text = $@"{dataGridViewRow.Cells["WorkOrder"].Value}";
        ...
        private void BindCombo_PartRouting()
        {
            ...
            comboBox_PartRouting.DataSource = _dataSet.Tables["PartRouting"];
        ...
        private void btn_Insert_Click(object sender, EventArgs e)
        {
            ...
            //2024-05-31 RepairInfo Updated 시간 = RepairHist Started 시간 
            //var  temp_string = $" Select Top(1) Updated From RepairInfo　Where PcbBcd = '{tb_Barcode.Text}' order by updated desc ";
            //var  input_time =  DbAccess.Default.ExecuteScalar(temp_string.ToString());      
            ...
            switch (repairResult)
            {
                case "C":
                    ...
                    {
                        //请选择部品工程
                        MessageBox.Show("Vui lòng chọn định tuyến một phần。(Please select part routing.)", "Không chọn(Not Select)", MessageBoxIcon.Warning);
                        return;
                    }
                    ...
                    {
                        //请选择维修员(Repairer)
                        MessageBox.Show("Vui lòng chọn người sửa hàng。(Please select Repairer.)", "Không chọn(Not Select)", MessageBoxIcon.Warning);
                        return;
                    }
