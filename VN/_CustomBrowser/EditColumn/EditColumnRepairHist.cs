...
namespace WiseM.Browser.EditColumn
{
    ...
    public class EditColumnRepairHist
    {
        private int _Repairhist;
        ...
        public EditColumnRepairHist()
        {
        }


        [CategoryAttribute("1.PRIMARY KEY"), ReadOnlyAttribute(true)]
        public int RepairHist
        {
            get { return _Repairhist; }
            set { _Repairhist = value; }
        }
        ...
        public string Repair
        {
            get
            {
                ...
                {
                    S = PropertyItemList._repairItems[0];
                }
